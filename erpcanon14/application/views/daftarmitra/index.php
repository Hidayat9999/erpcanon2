...
<a href="<?= base_url('daftar_mitra/excel');?>" class="btn btn-success mb-2 mt-2">Export Excel</a>

<div class="table-responsive pt-2 pr-2">
<!-- <table class="table" id="dataTable" width="" cellspacing="0"> -->
<table id="mytable" class="table table-striped table-bordered table-hover table-full-width dataTable" cellspacing="0" width="" style="font-size: 10px;">
...
<script>
    $('#mytable').dataTable({
        language: {
            search: "",
            searchPlaceholder: "Cari data mitra.."
        },
        bInfo: false
    });
</script>